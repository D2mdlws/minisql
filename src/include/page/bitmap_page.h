...
class BitmapPage {
 ...
 private:
  ...
  /**
   * Sets the allocation status of a page in the bitmap.
   *
   * @param page_offset The offset of the page in the bitmap.
   * @return True if the page allocation was successful, false otherwise.
   */
  bool SetPageAllocated(uint32_t page_offset);

  /**
   * Sets the deallocation status of a page in the bitmap.
   *
   * @param page_offset The offset of the page in the bitmap.
   * @return True if the page deallocation was successful, false otherwise.
   */
  bool SetPageFree(uint32_t page_offset);
